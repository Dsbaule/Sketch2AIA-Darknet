...
# Added for color coding by labels
colorDict = {
    'Screen':       '#d50000',
    'Label':        '#c51162',
    'Button':       '#aa00ff',
...
if os.name == "nt":
    ...
    lib = CDLL("/home/dsbaule/PycharmProjects/Sketch2AIA/darknet/libdarknet.so", RTLD_GLOBAL)
    ...
    if showImage:
        try:
            ...
            for detection in detections:
                ...
                boxColor = tuple(int(colorDict[label][i:i+2], 16) for i in (1, 3, 5))
